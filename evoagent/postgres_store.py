...
class PostgresTaskStore:
    ...
    def _init(self) -> None:
        statements = [
            ...
            "ALTER TABLE deployments ADD COLUMN IF NOT EXISTS max_disagreement_rate "
            "DOUBLE PRECISION NOT NULL DEFAULT .2",
            "ALTER TABLE deployments ADD COLUMN IF NOT EXISTS auto_promote "
            "BOOLEAN NOT NULL DEFAULT FALSE",
            "ALTER TABLE deployments ADD COLUMN IF NOT EXISTS shadow_samples "
            "INTEGER NOT NULL DEFAULT 0",
            "ALTER TABLE deployments ADD COLUMN IF NOT EXISTS disagreements "
            "INTEGER NOT NULL DEFAULT 0",
            """CREATE TABLE IF NOT EXISTS release_observations (
                ...
                created_at TIMESTAMPTZ NOT NULL)""",
            """CREATE INDEX IF NOT EXISTS idx_release_observations_lookup
