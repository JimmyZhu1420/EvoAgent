...
class TaskQueue:
    ...
    def close(self) -> None:
        self._stop.set()
        # A closed queue must not leave handlers using persistence resources in
        # the background. This is especially important for SQLite on Windows,
        # where an in-flight connection keeps the database file locked.
